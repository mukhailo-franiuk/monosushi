    ...
    return (
        <div className=" w-full flex flex-col items-center">
            ...
            <div className=" w-3/4 my-4">
                <h2 className=" mx-auto text-black text-2xl font-black text-left py-4">Monosushi – доставка неймовірно смачних суші у Львові.</h2>
                <p className="text-lg">Головний пріоритет – висока якість їжі та сервісу. Ми – команда професіоналів, яка щодня працює для
            ...
            <div className="w-3/4 my-4 flex flex-col">
                < div className="w-full my-2 overflow-hidden rounded-xl flex items-center justify-center">
                    <img src="https://monosushi.com.ua/wp-content/uploads/2022/07/img_1127-scaled-568x568.jpg" alt="" className="w-full"/>
                </div>
            ...
            <div className="w-3/4 my-4 flex flex-col">
                <div className="w-full flex flex-col my-2 items-center">
                    <h2 className="w-full text-left text-black text-2xl font-black py-2">
                ...
                < div className="w-full rounded-xl my-2 overflow-hidden">
                    <img src="https://monosushi.com.ua/wp-content/uploads/2022/07/img_8051-scaled-568x568.jpeg" alt="" className="w-full" />
                </div>
            </div>
            <div className=" w-4/5 my-4 flex flex-wrap items-center justify-center">
                <div className="w-full flex flex-col my-2 items-center">
                    <h2 className="w-full text-center text-black text-2xl font-black py-2">
                        Наші переваги
                    </h2>
                </div>
                {advantages.map((item , index) => 
                    <div className=" w-2/5 flex flex-col items-center justify-center my-4 border py-4 m-1 rounded-xl border-blue-300" key={index}>
