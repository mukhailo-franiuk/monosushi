    ...
    return (
        <div className=" w-full flex flex-col items-center">
            <div className="w-full my-6">
                <h1 className=" w-1/2 mx-auto text-black text-4xl font-black text-center border-t-4 border-blue-300 pt-4">Про нас</h1>
            </div>
            ...
            <div className=" w-3/5 my-4 flex flex-col">
                <div className="w-full flex flex-col my-2 items-center">
